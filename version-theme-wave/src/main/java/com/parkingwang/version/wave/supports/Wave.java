...
public class Wave extends View {
    ...
    private final float WAVE_LENGTH_MULTIPLE_LARGE = 3f;
    private final float WAVE_LENGTH_MULTIPLE_MIDDLE = 1f;
    private final float WAVE_LENGTH_MULTIPLE_LITTLE = 0.02f;
    ...
    private void calculatePath() {
        ...
        for (float x = 0; x <= mMaxRight; x += X_SPACE) {
            y = (float) (mWaveHeight * Math.sin(omega * x*2 + mBlowOffset) + mWaveHeight);
